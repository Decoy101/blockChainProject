...
function Homepage({ passLoading }) {
  return (
    <>
      <img src={HomeBG} alt="" className="absolute scale-105 -z-50" style={{"top":"-100px","left":"-1px"}}/>
      <div className="w-1/2" style={{"marginTop":"10rem"}}>
        <img className="w-full" src={BESTX} alt="bestx-logo" />
        <br />

        <p className="text-justify text-3xl" >
          BestX is a game that rewards musicians for creating quality content -
          and allows fans to contribute to their success.
        </p>
        <br />
        <div>
          <button className="border mr-8 rounded-full bg-yellow-400 p-4">
            Join the beta
          </button>
      ...
      <div className="text-center w-4/12 mx-auto my-48">
        ...
        <button className="border mt-16 rounded-full bg-yellow-400 p-4 text-cyan-900 ">
          Join the beta
        </button>
      </div>
    </>
